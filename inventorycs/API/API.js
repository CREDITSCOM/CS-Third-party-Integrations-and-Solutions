...
API_TransactionsStateGet_args.prototype.write = function(output) {
  ...
  if (this.id !== null && this.id !== undefined) {
    ...
    for (var iter213 in this.id)
    {
      if (this.id.hasOwnProperty(iter213))
      {
        iter213 = this.id[iter213];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem220 = null;
          elem220 = new ByteCodeObject();
          elem220.read(input);
          this.byteCodeObjects.push(elem220);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
API_ContractAllMethodsGet_args.prototype.write = function(output) {
  ...
  if (this.byteCodeObjects !== null && this.byteCodeObjects !== undefined) {
    ...
    for (var iter221 in this.byteCodeObjects)
    {
      if (this.byteCodeObjects.hasOwnProperty(iter221))
      {
        iter221 = this.byteCodeObjects[iter221];
