  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem188 = null;
          elem188 = input.readI64().value;
          this.id.push(elem188);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
API_TransactionsStateGet_args.prototype.write = function(output) {
  ...
  if (this.id !== null && this.id !== undefined) {
    ...
    for (var iter189 in this.id)
    {
      if (this.id.hasOwnProperty(iter189))
      {
        iter189 = this.id[iter189];
...
API_MembersSmartContractGet_args = function(args) {
  this.transactionId = null;
  if (args) {
    if (args.transactionId !== undefined && args.transactionId !== null) {
      this.transactionId = new TransactionId(args.transactionId);
...
API_MembersSmartContractGet_args.prototype = {};
API_MembersSmartContractGet_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
API_MembersSmartContractGet_args.prototype.write = function(output) {
  output.writeStructBegin('API_MembersSmartContractGet_args');
  if (this.transactionId !== null && this.transactionId !== undefined) {
    output.writeFieldBegin('transactionId', Thrift.Type.STRUCT, 1);
    this.transactionId.write(output);
    output.writeFieldEnd();
...
API_MembersSmartContractGet_result = function(args) {
  this.success = null;
  if (args) {
    if (args.success !== undefined && args.success !== null) {
      this.success = new MembersSmartContractGetResult(args.success);
    }
  }
};
API_MembersSmartContractGet_result.prototype = {};
API_MembersSmartContractGet_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      case 0:
      if (ftype == Thrift.Type.STRUCT) {
        this.success = new MembersSmartContractGetResult();
        this.success.read(input);
      } else {
        input.skip(ftype);
      }
...
API_MembersSmartContractGet_result.prototype.write = function(output) {
  output.writeStructBegin('API_MembersSmartContractGet_result');
  if (this.success !== null && this.success !== undefined) {
    output.writeFieldBegin('success', Thrift.Type.STRUCT, 0);
    this.success.write(output);
    output.writeFieldEnd();
...
APIClient.prototype.ContractAllMethodsGet = function(bytecode, callback) {
  this.send_ContractAllMethodsGet(bytecode, callback); 
  if (!callback) {
    return this.recv_ContractAllMethodsGet();
  }
};

APIClient.prototype.send_ContractAllMethodsGet = function(bytecode, callback) {
...
APIClient.prototype.MembersSmartContractGet = function(transactionId, callback) {
  this.send_MembersSmartContractGet(transactionId, callback); 
  if (!callback) {
    return this.recv_MembersSmartContractGet();
  }
};

APIClient.prototype.send_MembersSmartContractGet = function(transactionId, callback) {
  this.output.writeMessageBegin('MembersSmartContractGet', Thrift.MessageType.CALL, this.seqid);
  var params = {
    transactionId: transactionId
  };
  var args = new API_MembersSmartContractGet_args(params);
  args.write(this.output);
  this.output.writeMessageEnd();
  if (callback) {
    var self = this;
    this.output.getTransport().flush(true, function() {
      var result = null;
      try {
        result = self.recv_MembersSmartContractGet();
      } catch (e) {
        result = e;
      }
      callback(result);
...
APIClient.prototype.recv_MembersSmartContractGet = function() {
  var ret = this.input.readMessageBegin();
  var fname = ret.fname;
  var mtype = ret.mtype;
  var rseqid = ret.rseqid;
  ...
  var result = new API_MembersSmartContractGet_result();
  result.read(this.input);
  this.input.readMessageEnd();
  ...
  throw 'MembersSmartContractGet failed: unknown result';
};
