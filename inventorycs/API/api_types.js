...
SmartExecutionTransInfo.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    output.writeFieldBegin('params', Thrift.Type.LIST, 2);
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter23 in this.params)
    {
      if (this.params.hasOwnProperty(iter23))
      {
        iter23 = this.params[iter23];
        iter23.write(output);
      }
    }
    output.writeListEnd();
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i29 = 0; _i29 < _size24; ++_i29)
        {
          ...
          var key30 = null;
          var val31 = null;
          key30 = input.readByte().value;
          val31 = new CumulativeAmount();
          val31.read(input);
          this.balancePerCurrency[key30] = val31;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
PeriodStats.prototype.write = function(output) {
  ...
  if (this.balancePerCurrency !== null && this.balancePerCurrency !== undefined) {
    ...
    for (var kiter32 in this.balancePerCurrency)
    {
      if (this.balancePerCurrency.hasOwnProperty(kiter32))
      {
        var viter33 = this.balancePerCurrency[kiter32];
        output.writeByte(kiter32);
...
PoolListGetResult.prototype.write = function(output) {
  ...
  if (this.pools !== null && this.pools !== undefined) {
    ...
    for (var iter49 in this.pools)
    {
      if (this.pools.hasOwnProperty(iter49))
      {
        iter49 = this.pools[iter49];
        iter49.write(output);
      }
    }
    output.writeListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem64 = null;
          elem64 = new PeriodStats();
          elem64.read(input);
          this.stats.push(elem64);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
StatsGetResult.prototype.write = function(output) {
  ...
  if (this.stats !== null && this.stats !== undefined) {
    ...
    for (var iter65 in this.stats)
    {
      if (this.stats.hasOwnProperty(iter65))
      {
        iter65 = this.stats[iter65];
        iter65.write(output);
      }
    }
    output.writeListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem72 = null;
          elem72 = input.readBinary().value;
          this.addressesList.push(elem72);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractAddressesListGetResult.prototype.write = function(output) {
  ...
  if (this.addressesList !== null && this.addressesList !== undefined) {
    ...
    for (var iter73 in this.addressesList)
    {
      if (this.addressesList.hasOwnProperty(iter73))
      {
        iter73 = this.addressesList[iter73];
        output.writeBinary(iter73);
      }
    }
    output.writeListEnd();
    output.writeFieldEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem80 = null;
          elem80 = new SmartContract();
          elem80.read(input);
          this.smartContractsList.push(elem80);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractsListGetResult.prototype.write = function(output) {
  ...
  if (this.smartContractsList !== null && this.smartContractsList !== undefined) {
    ...
    for (var iter81 in this.smartContractsList)
    {
      if (this.smartContractsList.hasOwnProperty(iter81))
      {
        iter81 = this.smartContractsList[iter81];
        iter81.write(output);
      }
    }
    output.writeListEnd();
...
TransactionsStateGetResult.prototype.write = function(output) {
  ...
  if (this.states !== null && this.states !== undefined) {
    ...
    for (var kiter90 in this.states)
    {
      if (this.states.hasOwnProperty(kiter90))
      {
        var viter91 = this.states[kiter90];
        output.writeI64(kiter90);
...
SmartMethodParamsGetResult.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter99 in this.params)
    {
      if (this.params.hasOwnProperty(iter99))
      {
        iter99 = this.params[iter99];
        iter99.write(output);
      }
    }
    output.writeListEnd();
...
ContractAllMethodsGetResult.prototype.write = function(output) {
  ...
  if (this.methods !== null && this.methods !== undefined) {
    ...
    for (var iter107 in this.methods)
    {
      if (this.methods.hasOwnProperty(iter107))
      {
        iter107 = this.methods[iter107];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem114 = null;
          elem114 = new SmartContractMethodArgument();
          elem114.read(input);
          this.arguments.push(elem114);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractMethod.prototype.write = function(output) {
  ...
  if (this.arguments !== null && this.arguments !== undefined) {
    ...
    for (var iter115 in this.arguments)
    {
      if (this.arguments.hasOwnProperty(iter115))
      {
        iter115 = this.arguments[iter115];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem122 = null;
          elem122 = new SmartContractMethod();
          elem122.read(input);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        var _ktype124 = 0;
        var _vtype125 = 0;
        _rtmp3127 = input.readMapBegin();
        _ktype124 = _rtmp3127.ktype;
        _vtype125 = _rtmp3127.vtype;
...
SmartContractDataResult.prototype.write = function(output) {
  ...
  if (this.variables !== null && this.variables !== undefined) {
    ...
    for (var kiter132 in this.variables)
    {
      if (this.variables.hasOwnProperty(kiter132))
      {
        var viter133 = this.variables[kiter132];
...
TokenTransaction.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter149 in this.params)
    {
      if (this.params.hasOwnProperty(iter149))
      {
        iter149 = this.params[iter149];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem156 = null;
          elem156 = new TokenBalance();
          elem156.read(input);
          this.balances.push(elem156);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenBalancesResult.prototype.write = function(output) {
  ...
  if (this.balances !== null && this.balances !== undefined) {
    ...
    for (var iter157 in this.balances)
    {
      if (this.balances.hasOwnProperty(iter157))
      {
        iter157 = this.balances[iter157];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem164 = null;
          elem164 = new TokenTransfer();
          elem164.read(input);
          this.transfers.push(elem164);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransfersResult.prototype.write = function(output) {
  ...
  if (this.transfers !== null && this.transfers !== undefined) {
    ...
    for (var iter165 in this.transfers)
    {
      if (this.transfers.hasOwnProperty(iter165))
      {
        iter165 = this.transfers[iter165];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem172 = null;
          elem172 = new TokenTransaction();
          elem172.read(input);
          this.transactions.push(elem172);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransactionsResult.prototype.write = function(output) {
  ...
  if (this.transactions !== null && this.transactions !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
    for (var iter173 in this.transactions)
    {
      if (this.transactions.hasOwnProperty(iter173))
      {
        iter173 = this.transactions[iter173];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem180 = null;
          elem180 = new TokenHolder();
          elem180.read(input);
          this.holders.push(elem180);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenHoldersResult.prototype.write = function(output) {
  ...
  if (this.holders !== null && this.holders !== undefined) {
    ...
    for (var iter181 in this.holders)
    {
      if (this.holders.hasOwnProperty(iter181))
      {
        iter181 = this.holders[iter181];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem188 = null;
          elem188 = new TokenInfo();
          elem188.read(input);
          this.tokens.push(elem188);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokensListResult.prototype.write = function(output) {
  ...
  if (this.tokens !== null && this.tokens !== undefined) {
    ...
    for (var iter189 in this.tokens)
    {
      if (this.tokens.hasOwnProperty(iter189))
      {
        iter189 = this.tokens[iter189];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem196 = null;
          elem196 = new WalletInfo();
          elem196.read(input);
          this.wallets.push(elem196);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
WalletsGetResult.prototype.write = function(output) {
  ...
  if (this.wallets !== null && this.wallets !== undefined) {
    ...
    for (var iter197 in this.wallets)
    {
      if (this.wallets.hasOwnProperty(iter197))
      {
        iter197 = this.wallets[iter197];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem204 = null;
          elem204 = new TrustedInfo();
          elem204.read(input);
          this.writers.push(elem204);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TrustedGetResult.prototype.write = function(output) {
  ...
  if (this.writers !== null && this.writers !== undefined) {
    ...
    for (var iter205 in this.writers)
    {
      if (this.writers.hasOwnProperty(iter205))
      {
        iter205 = this.writers[iter205];
