    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i71 = 0; _i71 < _size66; ++_i71)
        {
          ...
          var key72 = null;
          var val73 = null;
          key72 = input.readI64().value;
          val73 = input.readI32().value;
          this.states[key72] = val73;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
TransactionsStateGetResult.prototype.write = function(output) {
  ...
  if (this.states !== null && this.states !== undefined) {
    ...
    for (var kiter74 in this.states)
    {
      if (this.states.hasOwnProperty(kiter74))
      {
        var viter75 = this.states[kiter74];
...
SmartMethodParamsGetResult.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter83 in this.params)
    {
      if (this.params.hasOwnProperty(iter83))
      {
        iter83 = this.params[iter83];
        iter83.write(output);
      }
    }
    output.writeListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem90 = null;
          elem90 = new MethodDescription();
          elem90.read(input);
          this.methods.push(elem90);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
ContractAllMethodsGetResult.prototype.write = function(output) {
  ...
  if (this.methods !== null && this.methods !== undefined) {
    ...
    for (var iter91 in this.methods)
    {
      if (this.methods.hasOwnProperty(iter91))
      {
        iter91 = this.methods[iter91];
        iter91.write(output);
      }
    }
    output.writeListEnd();
...
MembersSmartContractGetResult = function(args) {
  this.status = null;
  this.name = null;
  this.owner = null;
  this.decimal = null;
  ...
  if (args) {
    ...
    if (args.totalCoins !== undefined && args.totalCoins !== null) {
...
MembersSmartContractGetResult.prototype = {};
MembersSmartContractGetResult.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
    ...
    switch (fid)
    {
      ...
      case 4:
      if (ftype == Thrift.Type.STRING) {
        this.decimal = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
      case 5:
      if (ftype == Thrift.Type.STRING) {
        this.totalCoins = input.readString().value;
      } else {
        input.skip(ftype);
      }
      break;
...
MembersSmartContractGetResult.prototype.write = function(output) {
  output.writeStructBegin('MembersSmartContractGetResult');
  if (this.status !== null && this.status !== undefined) {
    output.writeFieldBegin('status', Thrift.Type.STRUCT, 1);
    this.status.write(output);
    output.writeFieldEnd();
  ...
  if (this.decimal !== null && this.decimal !== undefined) {
    output.writeFieldBegin('decimal', Thrift.Type.STRING, 4);
    output.writeString(this.decimal);
    output.writeFieldEnd();
  }
  if (this.totalCoins !== null && this.totalCoins !== undefined) {
    output.writeFieldBegin('totalCoins', Thrift.Type.STRING, 5);
    output.writeString(this.totalCoins);
    output.writeFieldEnd();
  }
  if (this.symbol !== null && this.symbol !== undefined) {
    output.writeFieldBegin('symbol', Thrift.Type.STRING, 6);
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem98 = null;
          elem98 = new SmartContractMethodArgument();
          elem98.read(input);
          this.arguments.push(elem98);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractMethod.prototype.write = function(output) {
  ...
  if (this.arguments !== null && this.arguments !== undefined) {
    ...
    for (var iter99 in this.arguments)
    {
      if (this.arguments.hasOwnProperty(iter99))
      {
        iter99 = this.arguments[iter99];
        iter99.write(output);
      }
    }
    output.writeListEnd();
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem106 = null;
          elem106 = new SmartContractMethod();
          elem106.read(input);
          this.methods.push(elem106);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
SmartContractDataResult.prototype.write = function(output) {
  ...
  if (this.variables !== null && this.variables !== undefined) {
    ...
    for (var kiter116 in this.variables)
    {
      if (this.variables.hasOwnProperty(kiter116))
      {
        var viter117 = this.variables[kiter116];
...
TokenTransaction.prototype.write = function(output) {
  ...
  if (this.params !== null && this.params !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.params.length);
    for (var iter125 in this.params)
    {
      if (this.params.hasOwnProperty(iter125))
      {
        iter125 = this.params[iter125];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem132 = null;
          elem132 = new TokenBalance();
          elem132.read(input);
          this.balances.push(elem132);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenBalancesResult.prototype.write = function(output) {
  ...
  if (this.balances !== null && this.balances !== undefined) {
    ...
    for (var iter133 in this.balances)
    {
      if (this.balances.hasOwnProperty(iter133))
      {
        iter133 = this.balances[iter133];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem140 = null;
          elem140 = new TokenTransfer();
          elem140.read(input);
          this.transfers.push(elem140);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransfersResult.prototype.write = function(output) {
  ...
  if (this.transfers !== null && this.transfers !== undefined) {
    ...
    for (var iter141 in this.transfers)
    {
      if (this.transfers.hasOwnProperty(iter141))
      {
        iter141 = this.transfers[iter141];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem148 = null;
          elem148 = new TokenTransaction();
          elem148.read(input);
          this.transactions.push(elem148);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenTransactionsResult.prototype.write = function(output) {
  ...
  if (this.transactions !== null && this.transactions !== undefined) {
    ...
    output.writeListBegin(Thrift.Type.STRUCT, this.transactions.length);
    for (var iter149 in this.transactions)
    {
      if (this.transactions.hasOwnProperty(iter149))
      {
        iter149 = this.transactions[iter149];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem156 = null;
          elem156 = new TokenHolder();
          elem156.read(input);
          this.holders.push(elem156);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokenHoldersResult.prototype.write = function(output) {
  ...
  if (this.holders !== null && this.holders !== undefined) {
    ...
    for (var iter157 in this.holders)
    {
      if (this.holders.hasOwnProperty(iter157))
      {
        iter157 = this.holders[iter157];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem164 = null;
          elem164 = new TokenInfo();
          elem164.read(input);
          this.tokens.push(elem164);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
TokensListResult.prototype.write = function(output) {
  ...
  if (this.tokens !== null && this.tokens !== undefined) {
    ...
    for (var iter165 in this.tokens)
    {
      if (this.tokens.hasOwnProperty(iter165))
      {
        iter165 = this.tokens[iter165];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem172 = null;
          elem172 = new WalletInfo();
          elem172.read(input);
          this.wallets.push(elem172);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
WalletsGetResult.prototype.write = function(output) {
  ...
  if (this.wallets !== null && this.wallets !== undefined) {
    ...
    for (var iter173 in this.wallets)
    {
      if (this.wallets.hasOwnProperty(iter173))
      {
        iter173 = this.wallets[iter173];
  ...
  while (true)
  {
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.LIST) {
        ...
        {
          var elem180 = null;
          elem180 = new WriterInfo();
          elem180.read(input);
          this.writers.push(elem180);
        }
        input.readListEnd();
      } else {
        input.skip(ftype);
...
WritersGetResult.prototype.write = function(output) {
  ...
  if (this.writers !== null && this.writers !== undefined) {
    ...
    for (var iter181 in this.writers)
    {
      if (this.writers.hasOwnProperty(iter181))
      {
        iter181 = this.writers[iter181];
